...
flowchart LR
    ...
    %% Styling (GitHub-friendly neutral tones)
    style A fill:#f6f8fa,stroke:#8c959f
    style H fill:#f6f8fa,stroke:#8c959f
    style E fill:#ffffff,stroke:#57606a,stroke-width:2px

    classDef encoder fill:#f6f8fa,stroke:#57606a
    classDef decoder fill:#ffffff,stroke:#57606a
